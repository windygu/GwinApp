...
namespace App.WinFrom.Menu
{
    ...
    public class ShowEntityManagementForm 
    {
        ...
        /// </param>
        public ShowEntityManagementForm(IBaseBAO Service, IBaseForm FormApplicationMdi)
        {
        ...
        {
            IBaseBAO baseRepository = this.Service
                .CreateEntityInstanceByType(TypeEntity);
        ...
        public void AfficherUneGestion<T>(IBaseBAO Service) where T : BaseEntity
        {
        ...
        public void AfficherUneGestion<T>(IBaseBAO Service,BaseEntryForm formulaire) where T : BaseEntity
        {
