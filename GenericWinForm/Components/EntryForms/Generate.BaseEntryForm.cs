            ...
            foreach (PropertyInfo item in listeProprite)
            {
                ...
                switch (item.PropertyType.Name)
                {
                    ...
                    case "String":
                        ...
                        stringField.Name = item.Name;
                        stringField.Location = new System.Drawing.Point(x_field, y_field);
                        stringField.OrientationField = orientation_config;
                        stringField.SizeLabel = new Size(width_label, height_label);
                        stringField.SizeControl = new Size(width_control_config, height_control);
                        if (configProperty.EntryForm?.MultiLine == true)
                        {
                            stringField.IsMultiline = true;
                            stringField.NombreLigne = configProperty.EntryForm.NumberLine;
                        }
                           
                        

                        stringField.TabIndex = ++TabIndex;
                        stringField.Text_Label = configProperty.DisplayProperty.Titre;
                        stringField.ConfigSizeField();

                        stringField.FieldChanged += ControlPropriete_ValueChanged;
                        if (configProperty.EntryForm?.isOblegatoir == true)
                            stringField.ValidatingFiled += textBoxString_Validating;
                        
                        // Insertion à l'interface
                        this.ConteneurFormulaire.Controls.Add(stringField);
                        field_control = stringField;
                    ...
                    case "Int32":
                        ...
                        int32Filed.OrientationField = orientation_config;
                        int32Filed.SizeLabel = new Size(width_label, height_label);
                        int32Filed.SizeControl = new Size(width_control_config, height_control);
                    ...
                    case "DateTime":
                        ...
                        dateTimeField.OrientationField = orientation_config;
                        dateTimeField.SizeLabel = new Size(width_label, height_label);
                        dateTimeField.SizeControl = new Size(width_control_config, height_control);
