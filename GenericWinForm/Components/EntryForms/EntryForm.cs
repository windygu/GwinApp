...
namespace App.WinForm
{
    ...
    public partial class EntryForm : BaseEntryForm
    {
        ...
        [Obsolete]
        public EntryForm(IBaseBAO service, BaseEntity entity, 
            Dictionary<string, object> critereRechercheFiltre) 
            : base(service, entity, critereRechercheFiltre,true)
        {
        ...
        /// 
        public EntryForm(IBaseBAO service) : this(service,null,null)
        {
