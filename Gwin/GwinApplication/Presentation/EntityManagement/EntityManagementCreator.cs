...
namespace App.Gwin.Application.Presentation.EntityManagement
{
    ...
    public class EntityManagementCreator
    {
        ...
        {
            IGwinBaseBLO baseRepository = GwinBaseBLO<BaseEntity>.CreateBLO_Instance(TypeEntity,GwinApp.Instance.TypeBaseBLO);
        ...
        public void ShowManagementForm<T>(IGwinBaseBLO Service) where T : BaseEntity
        {
        ...
        public void ShowManagementForm<T>(IGwinBaseBLO Service, BaseEntryForm formulaire) where T : BaseEntity
        {
