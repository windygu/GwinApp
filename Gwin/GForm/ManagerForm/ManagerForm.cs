...
namespace App.Gwin.Application.Presentation.EntityManagement
{
    ...
    public partial class ManagerForm : BaseForm
    {
        ...
        {
            // Normally this code must be in CreateAnsShowManagerFormHelper
            // But it generate bug with MetroFramework
            if (ManagementFormAttribute.WindowState.Maximized == this.EntityBLO.ConfigEntity.ManagementForm.Window_State)
            {
